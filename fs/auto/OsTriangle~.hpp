...
Compilation options: -lang cpp -light -cn OsTriangle -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __OsTriangle_H__
#define  __OsTriangle_H__
...
static float OsTriangle_faustpower2_f(float value) {
	return value * value;
}

class OsTriangle : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -light -cn OsTriangle -es 1 -mcd 16 -single -ftz 0");
		m->declare("filename", "OsTriangle.dsp");
	...
	virtual OsTriangle* clone() {
		return new OsTriangle();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("OsTriangle");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp0 = OsTriangle_faustpower2_f(2.0f * fRec1[0] + -1.0f);
			fVec1[0] = fTemp0;
