...
Compilation options: -lang cpp -light -cn FiResonhp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __FiResonhp_H__
#define  __FiResonhp_H__
...
static float FiResonhp_faustpower2_f(float value) {
	return value * value;
}

class FiResonhp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -light -cn FiResonhp -es 1 -mcd 16 -single -ftz 0");
		m->declare("filename", "FiResonhp.dsp");
	...
	virtual FiResonhp* clone() {
		return new FiResonhp();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("FiResonhp");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 2.0f * (1.0f - 1.0f / FiResonhp_faustpower2_f(fSlow0));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec0[0] = fTemp0 - fSlow5 * (fSlow4 * fRec0[2] + fSlow1 * fRec0[1]);
			output0[i0] = FAUSTFLOAT(fSlow6 * (fTemp0 - fSlow5 * (fRec0[2] + fRec0[0] + 2.0f * fRec0[1])));
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
		}
	}
