...
Compilation options: -lang cpp -light -cn OsSawtooth -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __OsSawtooth_H__
#define  __OsSawtooth_H__
...
class OsSawtooth : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -light -cn OsSawtooth -es 1 -mcd 16 -single -ftz 0");
		m->declare("filename", "OsSawtooth.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.5");
		m->declare("name", "OsSawtooth");
	...
	virtual OsSawtooth* clone() {
		return new OsSawtooth();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("OsSawtooth");
