...
Compilation options: -lang cpp -light -cn OsSquare -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __OsSquare_H__
#define  __OsSquare_H__
...
static float OsSquare_faustpower2_f(float value) {
	return value * value;
}

class OsSquare : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -light -cn OsSquare -es 1 -mcd 16 -single -ftz 0");
		m->declare("filename", "OsSquare.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.5");
		m->declare("name", "OsSquare");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("OsSquare");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp0 = OsSquare_faustpower2_f(2.0f * fRec0[0] + -1.0f);
			fVec1[0] = fTemp0;
