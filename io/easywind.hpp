#ifndef _IO_EASYWIND_HPP_
#define _IO_EASYWIND_HPP_
...
struct EasyWindController : public NativeWord {
    EasyWindController() {
        last_key_ = 0;
    ...
    virtual void run(Stack& stack) {
        ...
        if ( msg.type_  == MidiMessage::NoteOn ) {
            ...
            */
        } else if ( msg.type_ == MidiMessage::ControlChange ) {
            if ( msg.dd.d1_ == 2 ) {
                loud_from_ = loud_;
                loud_to_ = (float)msg.dd.d2_ / 127.0f;
            }
    ...
    NWORD_CREATOR_DEFINE_LR(EasyWindController)
private:
